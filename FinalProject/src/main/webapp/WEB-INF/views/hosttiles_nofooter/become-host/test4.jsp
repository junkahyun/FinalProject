...
<script type="text/javascript">
        ...
        function prevCalendar() {	
	        ...
	        //Date(today.getFullYear() 현재 년도, today.getMonth() 월, today.getDate() 일 )
            ...
            while (tbCalendar.rows.length > 2) {
             ...
             for (i=1; i<=lastDate.getDate(); i++) { //1일부터 마지막 일까지 돌림
	             ...
	             /*  if (cnt % 7 == 1) {	//일요일 계산
	                  ...
	                  //cell.innerHTML = "<font color=blue>" + i //1번째의 cell에만 색칠
	              }     */
	         /*      
...
<table id="calendar" align="center"> <!-- border="3" style="border-color:#3333FF " -->
    <tr>
        <td>
    ...
    <tr id="a" style="border: 1px solid red; padding: 5px;">
    </tr>
</table>
