	...
	$(document).ready(function(){
      	...
      	$("#searchAddrBtn").click(function() {
       	...
       	$("#pwd").blur(function(){
          	...
          	if(!bool) {
             	alert("암호는 영문,숫자,특수문자가 혼합된 10글자 이상이어야합니다.");
             	$(this).focus();
          	}
       	}); // end of $("#pwd").blur()---------------
       	...
       	$("#phone").blur(function(){
          	var phone = $(this).val();
          	var regExp_PHONE = /[1-9][0-9][0-9]/g;
          	var bool1 = regExp_PHONE.test(phone);
          	if(!bool) {
             	alert("핸드폰 번호를 형식에 맞게 입력해 줏메");
             	$(this).focus();
          	}
       	});// end of $("#hp2").blur()-------------
        	...
        	<div class="modal-content" style="width: 100%;padding:0;">
            	...
            	<span  style="text-align:center; margin-left:21%; font-weight: bold; color: #008489;" >페이스북</span><span  style="text-align:center; font-weight: bold; " >&nbsp;또는</span>&nbsp;<span  style="text-align:center;  font-weight: bold; color: #008489;" >구글</span><span  style="text-align:center; font-weight: bold; " >로 회원 가입하세요.</span>
          		<div style="padding:0;margin:0;">
			        ...
			        <div style="padding:0; border:solid;">
			        <div>
				        ...
				        <img src="<%= request.getContextPath() %>/resources/images/header/checked_green.png" style="position: absolute; right:3%;top:0;border:solid; z-index:3;" />
			        </div>
			        </div>
